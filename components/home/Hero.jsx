...
const Hero = () => {
  ...
  return (
    <div>
      <div className=" w-full hidden lg:block hero mt-[100px] min-h-screen relative">
...
"
                ...
                <h1 className=" lg:text-[62px] font-semibold text-center lg:text-left text-[30px] lg:leading-[65px]">
                  Stay connected <br />{" "}
      ...
      <div className=" block lg:hidden mob_hero mt-[100px]  py-5">
        <p
...
"
        ...
        <h1 className=" lg:text-[62px] font-semibold text-center lg:text-left text-[33px] lg:leading-[65px]">
          Stay connected <br /> <span className="text-[#e6485c]">wherever</span>{" "}
          you go
        </h1>
        ...
        <div className="flex px-5 mb-[30px] justify-center relative">
          <div className=" border shadow-md flex items-center  rounded-[12px] gap-2 mt-7  p-2 bg-white ">
            ...
            <div className="border-l relative">
              <input
                placeholder="Where do you need internet?"
                className="px-3 outline-none min-w-[240px]
                "
                onChange={(e) => setsearchVal(e.target.value)}
                onFocus={() => setIsFocus(true)}
                onBlur={() => setIsFocus(false)}
